...
export const PRODUCTS: Product[] = [
  // 1. Ворота откатные
  {
    ...
    badge: "Хит",
    description:
      "Откатные ворота — оптимальное решение для участка с ограниченным пространством. Полотно сдвигается вдоль забора по направляющей балке на роликовых опорах. Каркас из профильной трубы 60×40 и 40×20 мм, грунтовка ГФ-021 + порошковая или эмаль 3 в 1. Стандартный проём 4 м, высота полотна по выбору 1,5/1,8/2,0/2,5 м. Автоматика «Дорхан», CAME или Nice — по запросу.",
  },
  // 2. Ворота распашные
  {
