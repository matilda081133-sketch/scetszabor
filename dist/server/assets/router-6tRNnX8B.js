import { j as jsxRuntimeExports, a3 as deprecatedcreateImageUrlBuilder, a4 as createClient } from "./sanity-core-3hUdnev6.js";
import { f as functionalUpdate, a as arraysEqual, c as createLRUCache, i as isPromise, b as isRedirect, d as isNotFound, e as invariant, g as createControlledPromise, r as rootRouteId, h as isServer, j as compileDecodeCharMap, t as trimPath, k as rewriteBasepath, l as composeRewrites, p as processRouteTree, m as processRouteMasks, o as resolvePath, q as cleanPath, s as trimPathRight, u as parseHref, v as executeRewriteInput, w as isDangerousProtocol, x as redirect, y as findSingleMatch, z as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, A as interpolatePath, B as nullReplaceEqualDeep, C as replaceEqualDeep, E as last, F as decodePath, G as findFlatMatch, H as findRouteMatch, I as executeRewriteOutput, J as encodePathLikeUrl, K as trimPathLeft, L as joinPaths, M as useRouter, N as dummyMatchContext, O as matchContext, P as exactPathTest, Q as removeTrailingSlash, R as isModuleNotFoundError, S as useHydrated, T as escapeHtml, U as getAssetCrossOrigin, V as resolveManifestAssetLink, W as Outlet, n as notFound } from "./worker-entry-BdWGRx4M.js";
import { a as reactExports, m, I as Cookie, X } from "./lucide-DH97pPXW.js";
...
var Route$f = class Route extends BaseRoute {
  ...
  */
  constructor(options) {
    ...
    this.Link = m.forwardRef((props, ref) => {
...
const appCss = "/assets/styles-B9EH1fTa.css";
function CookieConsent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-6 left-6 right-6 md:left-auto md:max-w-md z-[999] animate-in fade-in slide-in-from-bottom-10 duration-500", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden rounded-2xl bg-graphite-deep shadow-2xl border border-white/10 p-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-0 right-0 h-1 hazard-stripe" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-10 rounded-full bg-orange/20 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Cookie, { className: "size-5 text-orange" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-display text-lg leading-tight", children: "Мы используем файлы cookie" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-white/60 leading-relaxed", children: "Это помогает нам улучшать сайт и делать его удобнее для вас. Оставаясь на сайте, вы соглашаетесь с нашей политикой конфиденциальности и обработкой персональных данных (в соответствии с 152-ФЗ)." }),
...
const Route$e = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Профессиональное строительство и установка заборов СПЕЦЗАБОР в Санкт-Петербурге и Ленинградской области. Профлист, евроштакетник, 3D-сетка, жалюзи, ворота. Гарантия 10 лет."
      },
      { property: "og:title", content: "СПЕЦЗАБОР | Заборы под ключ в СПб и ЛО" },
      {
        property: "og:description",
        content: "Инженерный замер, монтаж по ГОСТ, фотофиксация скрытых работ. Реальная гарантия 10 лет на все работы."
      },
...
const img1$2 = "/assets/vorota-raspashnye-1-5jJfXkFd.jpg";
const $$splitComponentImporter$d = () => import("./vorota-raspashnye-1QydxwO3.js");
const Route$d = createFileRoute("/vorota-raspashnye")({
  head: () => ({
    meta: [{
      title: "Распашные ворота под ключ — СПЕЦЗАБОР.РФ"
    }, {
      name: "description",
      content: "Распашные ворота из профлиста, штакетника, жалюзи. Усиленные петли, автоматика. От 55 000 ₽."
    }, {
      property: "og:title",
      content: "Распашные ворота — СПЕЦЗАБОР.РФ"
    }, {
      property: "og:image",
      content: img1$2
    }]
...
const img1$1 = "/assets/vorota-otkatnye-1-Cq98VO73.jpg";
const $$splitComponentImporter$c = () => import("./vorota-otkatnye-DEiKwXmh.js");
const Route$c = createFileRoute("/vorota-otkatnye")({
  head: () => ({
    meta: [{
      title: "Откатные ворота под ключ — СПЕЦЗАБОР.РФ"
    }, {
      name: "description",
      content: "Откатные автоматические ворота в СПб и ЛО. Ролики Дорхан, любая зашивка, привод CAME/Nice. От 85 000 ₽."
    }, {
      property: "og:title",
      content: "Откатные ворота — СПЕЦЗАБОР.РФ"
    }, {
      property: "og:image",
      content: img1$1
    }]
...
const p1 = "/assets/proflist-1-CDs9npD9.jpg";
const $$splitComponentImporter$b = () => import("./proflist-CwUv7mio.js");
const Route$b = createFileRoute("/proflist")({
  head: () => ({
    meta: [{
      title: "Заборы из профлиста под ключ — СПЕЦЗАБОР.РФ"
    }, {
      name: "description",
      content: "Монтаж заборов из профлиста С8 в СПб и ЛО. Усиленный металл, бетонирование, реальная гарантия. От 2 470 ₽/м.п."
    }, {
      property: "og:title",
      content: "Заборы из профлиста — СПЕЦЗАБОР.РФ"
    }, {
      property: "og:image",
      content: p1
    }]
...
const img1 = "/assets/kalitka-1-CPcvwGKb.jpg";
const $$splitComponentImporter$a = () => import("./kalitki-JLxIOXLo.js");
const Route$a = createFileRoute("/kalitki")({
  head: () => ({
    meta: [{
      title: "Калитки под ключ — СПЕЦЗАБОР.РФ"
    }, {
      name: "description",
      content: "Калитки под цвет забора. Замки, доводчики, домофон. От 24 000 ₽."
    }, {
      property: "og:title",
      content: "Калитки — СПЕЦЗАБОР.РФ"
    }, {
      property: "og:image",
      content: img1
    }]
...
const j1 = "/assets/jaluzi-1-3zxYH0M_.jpg";
const $$splitComponentImporter$9 = () => import("./jaluzi-D30gl2zN.js");
const Route$9 = createFileRoute("/jaluzi")({
  head: () => ({
    meta: [{
      title: "Заборы-жалюзи (ламели) — СПЕЦЗАБОР.РФ"
    }, {
      name: "description",
      content: "Премиальные заборы из ламелей-жалюзи. Приватность с продуваемостью, любой RAL и текстуры дерева. От 4 490 ₽/м.п."
    }, {
      property: "og:title",
      content: "Заборы-жалюзи"
    }, {
      property: "og:image",
      content: j1
    }]
...
const g1 = "/assets/gitter-1-D-mNGUAq.jpg";
const $$splitComponentImporter$8 = () => import("./gitter-Dl6mZBYo.js");
const Route$8 = createFileRoute("/gitter")({
  head: () => ({
    meta: [{
      title: "Заборы из 3D-сетки Gitter — СПЕЦЗАБОР.РФ"
    }, {
      name: "description",
      content: "3D-сетка Gitter для дач, СНТ, промобъектов. Пруток 3 и 3,8 мм, цинк + полимер. От 1 490 ₽/м.п."
    }, {
      property: "og:title",
      content: "Заборы из 3D-сетки Gitter"
    }, {
      property: "og:image",
      content: g1
    }]
...
const e1 = "/assets/evro-1-Bi_Khvnz.jpg";
const $$splitComponentImporter$7 = () => import("./evroshtaketnik-DrQ-9bLz.js");
const Route$7 = createFileRoute("/evroshtaketnik")({
  head: () => ({
    meta: [{
      title: "Заборы из евроштакетника — СПЕЦЗАБОР.РФ"
    }, {
      name: "description",
      content: "Евроштакетник в один ряд, шахматка, горизонталь. Двусторонний полимер, любой RAL. Монтаж в СПб и ЛО."
    }, {
      property: "og:title",
      content: "Заборы из евроштакетника"
    }, {
      property: "og:image",
      content: e1
    }]
...
const hero = "/assets/avtorskie-2-DHc9qYwh.jpg";
const $$splitComponentImporter$6 = () => import("./dizainerskie-C8Ja2bkG.js");
const Route$6 = createFileRoute("/dizainerskie")({
  head: () => ({
    meta: [{
      title: "Авторские заборы премиум — СПЕЦЗАБОР.РФ"
    }, {
      name: "description",
      content: "Кирпичные столбы, габионы, бетонные ленты, блоки, сварные секции, забор-расчёска. Эксклюзивные решения для премиум-сегмента."
    }, {
      property: "og:title",
      content: "Авторские заборы — СПЕЦЗАБОР.РФ"
    }, {
      property: "og:image",
      content: hero
    }]
...
const $$splitComponentImporter$5 = () => import("./catalog-CJnbyzec.js");
const Route$5 = createFileRoute("/catalog")({
  head: () => ({
    meta: [{
      title: "Каталог заборов и ворот — СПЕЦЗАБОР"
    }, {
      name: "description",
      content: "Каталог заборов: профлист, евроштакетник, 3D-сетка, жалюзи, дизайнерские, ворота. Цены под ключ для СПб и Ленобласти."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./admin-DInSiOyt.js");
const Route$4 = createFileRoute("/admin")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./index-1biibXFG.js");
const Route$3 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Производство и монтаж заборов СПЕЦЗАБОР в СПб и Ленобласти: откатные ворота, профнастил, евроштакетник, 3D сетка. Точный расчет в онлайн калькуляторе, ГОСТовая сварка, инженерный замер. Реальная гарантия."
    }, {
      name: "keywords",
      content: "заборы под ключ, спецзабор, забор спб, установка заборов, откатные ворота, профнастил, евроштакетник, калькулятор забора"
    }]
  }),
...
const $$splitComponentImporter$2 = () => import("./index-DUrjTLk-.js");
const Route$2 = createFileRoute("/studio/")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./_-BRL8jTHz.js");
reactExports.lazy(() => import("./pane2-bv6M8lFk.js").then((n) => n.n));
const Route$1 = createFileRoute("/studio/$")({
...
const client = createClient({
  ...
  dataset: "production",
  useCdn: false,
  // Set to false for authenticated/fresh requests
...
const builder = deprecatedcreateImageUrlBuilder(client);
...
const p2 = "/assets/proflist-2-CGrnok76.jpg";
const evro2 = "/assets/evro-2-HEX8vv1O.jpg";
const e2 = "/assets/shahmatka-1-BhTTvBcD.jpg";
const shahmatka2 = "/assets/shahmatka-2-BZkpJ0Qj.jpg";
const j2 = "/assets/jaluzi-2-Diokv4Cy.jpg";
const design1 = "/assets/design-1-BX6_7GMz.jpg";
const design2 = "/assets/design-2-DGEcaKux.jpg";
const img2$2 = "/assets/raschoska-2-ngEOWRYi.jpg";
const img2$1 = "/assets/vorota-otkatnye-2-p6ELIANe.jpg";
const img2 = "/assets/kalitka-2-BM9XaSS5.jpg";
const g2 = "/assets/gitter-2-4qpgUJm-.jpg";
const CATEGORIES = {
  "vorota-otkatnye": {
...
function transformSanityProduct(sp) {
  return {
    id: sp.slug.current,
    category: sp.slug.current.includes("vorota") ? sp.slug.current : "proflist",
    // Basic mapping, adjust as needed
    title: sp.title,
    short: sp.description || "",
    pricePerM: sp.price || 0,
    height: "1,8 м",
    // Default or extract from description
    features: [],
    images: sp.gallery?.map((img) => img.asset?.url) || [],
...
const PRODUCTS = DYNAMIC_PRODUCTS.length > 0 ? DYNAMIC_PRODUCTS : STATIC_PRODUCTS;
...
const CATEGORIES_ORDERED = Object.values(CATEGORIES).sort((a, b) => a.order - b.order);
const $$splitComponentImporter = () => import("./products._productId-D8IF8FCH.js");
const $$splitErrorComponentImporter = () => import("./products._productId-CN2pUjo5.js");
const $$splitNotFoundComponentImporter = () => import("./products._productId-C9nzDYTM.js");
const Route2 = createFileRoute("/products/$productId")({
  head: ({
    ...
    if (!product) return {
      meta: [{
        title: "Товар не найден — СПЕЦЗАБОР.РФ"
      }]
    };
    return {
      meta: [{
...
const VorotaRaspashnyeRoute = Route$d.update({
  id: "/vorota-raspashnye",
  path: "/vorota-raspashnye",
  getParentRoute: () => Route$e
});
const VorotaOtkatnyeRoute = Route$c.update({
  id: "/vorota-otkatnye",
  path: "/vorota-otkatnye",
  getParentRoute: () => Route$e
});
const ProflistRoute = Route$b.update({
  id: "/proflist",
  path: "/proflist",
  getParentRoute: () => Route$e
});
const KalitkiRoute = Route$a.update({
  id: "/kalitki",
  path: "/kalitki",
  getParentRoute: () => Route$e
});
const JaluziRoute = Route$9.update({
  id: "/jaluzi",
  path: "/jaluzi",
  getParentRoute: () => Route$e
});
const GitterRoute = Route$8.update({
  id: "/gitter",
  path: "/gitter",
  getParentRoute: () => Route$e
});
const EvroshtaketnikRoute = Route$7.update({
  id: "/evroshtaketnik",
  path: "/evroshtaketnik",
  getParentRoute: () => Route$e
});
const DizainerskieRoute = Route$6.update({
  id: "/dizainerskie",
  path: "/dizainerskie",
  getParentRoute: () => Route$e
});
const CatalogRoute = Route$5.update({
  id: "/catalog",
  path: "/catalog",
  getParentRoute: () => Route$e
});
...
const StudioIndexRoute = Route$2.update({
  id: "/studio/",
  path: "/studio/",
  getParentRoute: () => Route$e
});
const StudioSplatRoute = Route$1.update({
  id: "/studio/$",
  path: "/studio/$",
  getParentRoute: () => Route$e
});
...
export {
  ...
  j1 as j,
  g2 as k,
  productsByCategory as l,
  CATEGORIES_ORDERED as m,
  client as n,
  productById as o,
  p1 as p,
  fetchCmsData as q,
