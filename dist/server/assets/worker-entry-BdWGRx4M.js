...
import { a5 as ReadStream, a6 as WriteStream, j as jsxRuntimeExports, a7 as ReactDOMServer } from "./sanity-core-3hUdnev6.js";
import { AsyncLocalStorage } from "node:async_hooks";
import { a as reactExports, m as m$1 } from "./lucide-DH97pPXW.js";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BLvtok4Y.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-6tRNnX8B.js").then((n2) => n2.v),
