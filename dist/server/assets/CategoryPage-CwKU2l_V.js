...
import { S as SiteLayout, t as tgLink, C as CONTACTS } from "./SiteLayout-5rQyx1ku.js";
import { P as ProductCard } from "./ProductCard-B-2v5fgT.js";
import { C as Calculator } from "./Calculator-BScDmz7o.js";
import { l as productsByCategory, C as CATEGORIES, u as urlFor, S as SectionHeader, L as Link, P as PRODUCTS } from "./router-6tRNnX8B.js";
import { M as MessageCircle, R as Ruler, H as Hammer, C as Camera, S as ShieldCheck, a as reactExports, T as Truck, d as CalendarClock, W as Wrench, P as Phone, e as Send, f as Mail, h as MapPin, i as Clock } from "./lucide-DH97pPXW.js";
...
function CategoryPage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteLayout, { children: [
    ...
    variants.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "container-x py-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 grid gap-5 md:grid-cols-3", children: variants.map((v) => {
        const card = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group rounded-xl overflow-hidden bg-card border border-border hover:border-orange hover:-translate-y-0.5 transition-all h-full", children: [
        ...
        return v.href ? /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: v.href, className: "block", children: card }, v.title) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: card }, v.title);
      }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "products", className: "container-x pb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { kicker: "Каталог", title: "Топ позиций каталога" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: `mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3`,
          children: [...PRODUCTS].sort(() => 0.5 - Math.random()).slice(0, 3).map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProductCard, { product: p }, p.id))
        }
      )
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 grid gap-6 lg:grid-cols-[1fr_1fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-card border border-border p-6 md:p-8 text-left", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-6 grid gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ContactRow, { icon: MessageCircle, label: "MAX", value: "Написать в MAX", href: CONTACTS.maxUrl, external: true }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 grid gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `rounded-md px-6 py-3.5 transition-colors ${status === "success" ? "bg-green-600 text-white" : "btn-yellow text-graphite-deep"}`,
                children: status === "loading" ? "Отправка..." : status === "success" ? "Заявка отправлена!" : "Отправить заявку"
              }
            ),
            status === "error" && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-400 text-sm mt-1", children: "Ошибка отправки. Попробуйте еще раз." }),
