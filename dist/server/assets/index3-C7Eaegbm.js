import { c as compilerRuntimeExports, u as useI18nText, j as jsxRuntimeExports, k as kt, B as Button, A as ArrowLeftIcon, f as useGetI18nText, g as CommandList, e as Box, T as Text } from "./sanity-core-3hUdnev6.js";
import "./lucide-DH97pPXW.js";
import { P as Pane, _ as _DEBUG, u as useStructureTool, b as usePane, B as BackLink, a as PaneHeader$1, d as usePaneLayout, e as PaneContent, f as PaneItem, c as PaneHeaderActions } from "./pane2-bv6M8lFk.js";
import "util";
import "os";
const DividerContainer = kt(Box).withConfig({
  displayName: "DividerContainer",
  componentId: "sc-j4cdg4-0"
})`display:flex;align-items:center;gap:1rem;margin:0.75rem 0 0.25rem 0;`, Divider = kt.hr.withConfig({
  displayName: "Divider",
  componentId: "sc-j4cdg4-1"
})`flex:1;background-color:var(--card-border-color);height:1px;margin:0;border:none;`, DividerTitle = kt(Text).withConfig({
