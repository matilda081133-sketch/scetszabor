...
import { R as Route, n as productById, C as CATEGORIES, k as productsByCategory, L as Link, u as urlFor } from "./router-BV1aMPGC.js";
import { n as notFound } from "./worker-entry-C8GrbVsW.js";
import { a as reactExports, p as ChevronLeft, q as ChevronRight, o as Check, R as Ruler, H as Hammer, C as Camera, S as ShieldCheck } from "./lucide-02V0d3fb.js";
...
function ProductPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteLayout, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 rounded-2xl bg-graphite-deep text-white p-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 grid grid-cols-2 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: tgLink(`расчёт стоимости — ${product.title}`), target: "_blank", rel: "noopener noreferrer", className: "rounded-md btn-yellow text-center py-3", children: "Рассчитать стоимость" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container-x pb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LeadBlock, { title: `Вызвать инженера — ${product.title}`, subtitle: "Бесплатный замер. 3D-эскиз и смета в подарок." }) })
  ] });
}
export {
