...
const Cookie = createLucideIcon("cookie", __iconNode$p);
const __iconNode$o = [
...
const FilePenLine = createLucideIcon("file-pen-line", __iconNode$n);
const __iconNode$m = [
...
const RussianRuble = createLucideIcon("russian-ruble", __iconNode$e);
const __iconNode$d = [
  [
    "path",
    {
